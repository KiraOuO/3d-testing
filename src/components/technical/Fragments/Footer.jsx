...
const Footer = () => {
    return (
        <footer className="bg-transparent dark:bg-[#3a3a3c]">
            <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="flex justify-center text-teal-600">
                    ...
                    >
                        ...
                        <p className="dark:text-white text-[18px] font-bold cursor-pointer flex text-black ">
                            Shoes &nbsp;
                    ...
                    {socialLinks.map((link, index) => (
                        <li key={index}>
                            <a
                                ...
                                rel="noreferrer"
                                target="_blank"
                                className="text-blue-500 dark:text-[#8da7be] transition hover:text-gray-700/75"
                            >
